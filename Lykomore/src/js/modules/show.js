...
if (filterShowInit) {
  function showCode(showBtn, itemsNum, collapseBtn, listItem, lists) {
    ...
    show.addEventListener("click", function () {
      ...
      if (productsLength > (items - 3)) { // пишем вместо 3 чисто из items +3 которое ниже
  ...
  document.addEventListener("click", function (e) {
    ...
    if (elementInteractive.closest(".filter-block__search")) { // При нажатии на кнопку, происходит поиск отелей по данным из инпутов
        ...
        .then(function (data) {
          ...
          base.forEach(function (base) {
            ...
            if (base.arrivalDate === arrivalDate && base.dateOfDeparture === dateOfDeparture && base.numberOfGuests === numberOfGuests) {
              ...
              <h3 class="filter-list__title form-all-value title-v5">
                ${base.name}
              </h3>
